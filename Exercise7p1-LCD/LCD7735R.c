...
#define GPIO_PIN_DC GPIO_Pin_4 // on port GPIOB
#define GPIO_PIN_RST GPIO_Pin_3 // on port GPIOB
#define GPIO_PIN_SCE GPIO_Pin_5 // on port GPIOB
#define GPIO_PIN_SD_CS GPIO_Pin_6 // on port GPIOB
